package com.ameliaWx.wxArchives.earthWeather.nexrad;
...
//			System.out.println((key.substring(key.length() - 4)));
//			System.out.println(!".tar".equals(key.substring(key.length() - 4)));
			
			if(!filterMdm || (!"MDM".equals(key.substring(key.length() - 3)) && !".tar".equals(key.substring(key.length() - 4)))) {
